...
void show_help (void)
{
  ...
  printf(
    ...
    "\n"
    "   cachedb_dir (it must be configed if use_cache is not \"\")\n"
    "      - local db to use for local file cache\n"
    "\n"
    "   cachepage_dir (it must be configed if use_cache is not \"\")\n"
    "      - local pagelist to use for local file cache\n"
    "\n"
